...
const quickLinks = [
  ...
  { label: 'Book Service', href: '/contact#booking' },
]
    ...
    <footer className="bg-brand-blue-dark text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="mt-4 text-white/70 text-sm leading-relaxed">
              A modern, dependable mechanical brand delivering total comfort solutions for
          ...
          {/* Quick Links */}
          <div>
            <h3 className="font-bold text-sm uppercase tracking-widest text-brand-orange mb-5">
              Quick Links
            </h3>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-white/70">
              <li className="flex gap-3">
                ...
                <div>
                  <div className="text-white font-medium">(437) 432-3594</div>
                  <div className="text-xs opacity-70">Available 24/7 for emergencies</div>
                </div>
              </li>
              <li className="flex gap-3">
                <svg className="w-5 h-5 text-brand-orange flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                ...
                <span>info@bluehif2mechanical.com</span>
              </li>
              <li className="flex gap-3">
                <svg className="w-5 h-5 text-brand-orange flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
              ...
              <li className="flex gap-3">
                ...
                <div>
                  ...
                  <div className="text-xs opacity-70">Emergency: 24/7</div>
                </div>
              </li>
            </ul>
          </div>
      ...
      <div className="border-t border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 flex flex-col sm:flex-row items-center justify-between gap-2 text-xs text-white/50">
          <p>&copy; {new Date().getFullYear()} Blue HIF₂ Mechanical Inc. All rights reserved.</p>
          <p>Licensed &amp; Insured | Reliability · Quality · Efficiency · Safety</p>
        </div>
      </div>
    </footer>
  )
